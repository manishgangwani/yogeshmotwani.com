...
export default function Index() {
  ...
  const projects = [
    ...
    { title: "Roku Copilot", category: "Roku", tags: ["AI agent", "Content tool UX"], href: "https://www.figma.com/deck/l5EsuDGDKF8wkdoc5DoeDM/Copilot?node-id=1-42&viewport=-19096%2C-85%2C0.58&t=a29bgLfqad6ekmNi-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1", image: "/images/Copilot.png" },
    { title: "Roku Search Feeds", category: "Roku", tags: ["Web portal", "B2B UX"], href: "/projects/Search feed.pdf", image: "/images/Search feed.png" },
    // { title: "Roku Developers", category: "Roku", tags: ["Web portal", "Branding"], href: "/projects/Roku Launchpad.pdf", image: "/images/Launchpad.png" }, // Hidden — replaced by Roku Copilot. Files retained.
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                {[
                  { icon: Lightbulb, title: "UX Design" },
